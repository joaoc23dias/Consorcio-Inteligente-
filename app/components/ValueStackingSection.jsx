    ...
    <section className="bg-gradient-to-b from-black to-gray-950 text-white py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 text-center mb-12">
          Simples: Aqui está quanto você vai ganhar aplicando o Método SPA vs continuar financiando
        </p>
          ...
          <div className="space-y-6 mb-12">
            ...
            <div className="flex items-start gap-6 pb-6 border-b border-yellow-500/30">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-lg mb-2">ECONOMIA EM JUROS (vs Banco)</h4>
            ...
            <div className="flex items-start gap-6 pb-6 border-b border-yellow-500/30">
              <div className="text-3xl">💚</div>
              <div className="flex-1">
                <h4 className="font-bold text-lg mb-2">RENDA PASSIVA (Imóvel #2+)</h4>
                <p className="text-gray-300 text-sm mb-3">Estimado 2-4k/mês em aluguel</p>
                <p className="text-3xl font-bold text-green-400">R$ 192.000</p>
                <p className="text-gray-400 text-sm mt-2">em 4 anos</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6 pb-6 border-b border-yellow-500/30">
              <div className="text-3xl">📈</div>
              <div className="flex-1">
                <h4 className="font-bold text-lg mb-2">PATRIMÔNIO MULTIPLICADO</h4>
                ...
                <p className="text-gray-400 text-sm mt-2">valor adicional</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              <div className="text-3xl">🎁</div>
              <div className="flex-1">
                <h4 className="font-bold text-lg mb-2">OPORTUNIDADES/FLEXIBILIDADE</h4>
                ...
                <p className="text-gray-400 text-sm mt-2">valor não quantificável</p>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-6">
            <h4 className="font-bold text-lg mb-4 text-red-300">❌ COM BANCO (30 anos)</h4>
            <ul className="space-y-3 text-sm text-gray-300">
              <li>📦 1 imóvel apenas</li>
              <li>💸 R$ 680k perdido em juros</li>
              <li>🚫 Sem renda passiva</li>
              <li>🔒 Fluxo preso em hipoteca</li>
            </ul>
          </div>
