...
const guarantees = [
  { title: 'Garantia de Satisfacao (30 dias)', description: 'Se em 30 dias voce achar que o metodo nao e para voce, devolvemos 100% do investimento. Sem perguntas, sem burocracia.' },
  { title: 'Garantia de Resultado', description: 'Se voce seguir o metodo e nao for contemplado no prazo estrategico planejado, trabalhamos com voce de graca ate contemplar.' },
  { title: 'Garantia de Suporte Vitalicio', description: 'Acesso ao nosso time de especialistas durante todo o periodo de participacao no consorcio, sem custo extra.' },
  { title: 'Garantia de Propriedades Verificadas', description: 'Todas as oportunidades sao analisadas por especialistas para garantir o maximo retorno do seu patrimonio.' }
];
    ...
    <section className="py-24 px-4 bg-black">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Voce Nao Corre Nenhum Risco</h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">Invertemos todo o risco para o nosso lado com uma garantia tripla incondicional</p>
        ...
        <div className="bg-gradient-to-r from-green-950 via-gray-900 to-green-950 rounded-lg p-10 mb-16 border border-green-700 border-opacity-50">
          <h3 className="text-2xl font-bold text-white mb-4 text-center">Nossa Promessa Para Voce</h3>
          <p className="text-gray-300 text-lg text-center mb-6 leading-relaxed">Ou voce conquista seus imoveis com o Metodo SPA, ou voce nao paga nada. O risco e todo nosso. A unica forma de voce sair perdendo e nao tentar.</p>
          <p className="text-green-400 font-bold text-center">Nenhuma pergunta. Nenhuma burocracia. Apenas resultado ou reembolso completo.</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-6">A satisfacao do cliente e nossa prioridade. Garantia tripla, sem riscos.</p>
        </div>
      </div>
    </section>
  );
