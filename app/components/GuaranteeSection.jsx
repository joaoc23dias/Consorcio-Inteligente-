...
const garantias = [
  ...
  },
  {
    ...
    descricao: 'Acompanhamento do nosso time de especialistas durante todo o seu período de participação no consórcio, sem custo extra.',
    color: '#F59E0B',
  },
  {
    icon: '✅',
  ...
  return (
    <section ref={ref} className="section bg-noise" style={{ backgroundColor: 'var(--bg-primary)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container">
        ...
        {/* Guarantee cards — grid 2x2 FIXO, sem card solto */}
        <div
