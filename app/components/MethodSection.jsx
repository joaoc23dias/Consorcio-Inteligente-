...
const steps = [
  {
    ...
    desc: 'Analisamos milhares de grupos ativos no Brasil com nossa metodologia proprietária. Identificamos apenas os que têm perfil ideal para lance estratégico — liquidez, taxa, prazo e histórico de contemplação.',
  ...
  },
  {
    ...
    desc: 'Cruzamos seu objetivo (moradia, renda passiva ou aceleração patrimonial) com os grupos filtrados. Você recebe uma lista curta e qualificada — não perda de tempo com grupos que nunca vão contemplar no prazo.',
  ...
  },
  {
    ...
    desc: 'Com o Modelo SPA® de cálculo de lance, você sabe exatamente quanto ofertar para maximizar a probabilidade de contemplação no menor prazo. Fim dos chutes. Início da estratégia com dados.',
    metric: '14-36 meses para contemplar',
    color: '#10B981',
  },
];
      ...
      <div className="container">
        <div className={`reveal ${visible ? 'visible' : ''}`} style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p className="text-lead" style={{ maxWidth: '40rem', margin: '0 auto' }}>
            3 etapas. Dados reais. Zero sorte. Esse é o processo que transforma consórcio comum em máquina de patrimônio.
          </p>
        </div>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '1rem', padding: '1.25rem 2rem', background: 'rgba(255,90,31,0.06)', border: '1px solid rgba(255,90,31,0.2)', borderRadius: 'var(--radius-lg)' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              <p style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.15rem' }}>
                Resultado médio dos clientes Método SPA®
              </p>
              <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                Contemplação em <strong style={{ color: 'var(--accent-orange)' }}>14-36 meses</strong> — vs. média do mercado de <strong style={{ color: '#ef4444' }}>60+ meses</strong>
              </p>
            </div>
          </div>
        </div>
