    ...
    <section ref={ref} className="section" style={{ backgroundColor: 'var(--bg-primary)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container">
        ...
        <div className={`card-glass reveal ${visible ? 'visible' : ''} delay-1`} style={{ marginBottom: '3rem', textAlign: 'center', padding: '2.5rem' }}>
          {expired ? (
            /* Prazo expirado — escassez verdadeira: lista de espera */
            <div>
              <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem', fontSize: '1rem', fontWeight: 700 }}>
                ⏰ As vagas desta turma foram preenchidas
              </p>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginBottom: '1.25rem' }}>
                Entre na lista de espera e seja avisado quando a próxima turma abrir.
              </p>
              <a
                ...
                style={{
                  ...
                  padding: '0.7rem 1.5rem', borderRadius: '0.625rem',
                  textDecoration: 'none',
                }}
              >
            ...
            /* Prazo ativo — mostrar vagas e countdown */
            <div>
              {/* Vagas restantes */}
              <div style={{
                display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
                background: 'rgba(255,90,31,0.08)', border: '1px solid rgba(255,90,31,0.25)',
                borderRadius: '0.5rem', padding: '0.5rem 1.2rem',
                marginBottom: '1.5rem',
              }}>
                <span style={{ color: 'var(--accent-orange)', fontWeight: 800, fontSize: '1.1rem' }}>🔴</span>
                <span style={{ color: 'var(--text-primary)', fontWeight: 700, fontSize: '0.95rem' }}>
                  Restam apenas <span style={{ color: 'var(--accent-orange)' }}>{VAGAS_RESTANTES} vagas</span> para a turma atual
                </span>
              </div>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', marginBottom: '1rem', fontStyle: 'italic' }}>
                Vagas limitadas por conta do suporte 1×1 com especialista
              </p>

              {/* Countdown */}
              <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem', fontSize: '0.85rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                ⏱️ Tempo Restante da Oferta
              </p>
