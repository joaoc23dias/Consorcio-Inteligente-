...
{ num: '03', icon: '⚡', title: 'Busque 3 Imóveis em até 36 Meses', desc: 'A média do mercado é 60+ meses no sorteio. Com o Método SPA®, nossos clientes buscam antecipar via lance estratégico — e têm alcançado resultados expressivos em prazos significativamente menores. Resultados individuais variam.' },
{ num: '04', icon: '🏦', title: 'Desbloqueie 100% do Fluxo de Caixa', desc: 'Sem hipoteca. Após o recebimento da carta de crédito no consórcio, o fluxo é inteiramente seu. Reinvista a mesma parcela para acelerar a próxima carta de crédito e multiplicar o patrimônio.' },
...
{ num: '06', icon: '🚀', title: 'Multiplique Patrimônio 3X Mais Rápido', desc: 'Banco: linear — 1 imóvel a cada 5 anos. Consórcio com estratégia: múltiplos ativos em prazo menor. Essa é a diferença que o Método SPA® proporciona — acumulação patrimonial acelerada com dados.' },
];
...
para Acelerar Seu Patrimônio
</h2>
<p className="text-lead" style={{ maxWidth: '40rem', margin: '0 auto' }}>
Cada estratégia foi aplicada com +200 clientes reais. Não é teoria — é o que o consórcio faz quando usado com inteligência e dados.
</p>
</div>
