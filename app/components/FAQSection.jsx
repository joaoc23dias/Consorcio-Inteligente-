...
const faqs = [
{ question: 'Como funciona o Consórcio Inteligente?', answer: 'Você entra num grupo, paga parcelas mensais e usa lançes estratégicos para ser contemplado antes da média. Sem banco, sem juros, sem esperar sorteio. O Método SPA® identifica os grupos certos e calcula o lance ideal para contemplação em 14-36 meses.' },
...
{ question: 'Preciso de quanto dinheiro para começar?', answer: 'Depende do imóvel que você quer. Como regra geral: ter de 15% a 30% do valor do bem disponível para lance inicial coloca você numa posição estratégica forte. Nossa Sessão de Diagnóstico Estratégico calcula o número exato para o seu perfil.' },
