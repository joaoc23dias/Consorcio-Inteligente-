...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      <header className="fixed top-0 w-full bg-black/95 border-b border-yellow-600/20">
      ...
      <section className="pt-32 pb-20 px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          ...
          <a href="https://calendar.app.google/vrfs719bs8DdDrst8" className="border-2 border-yellow-600 text-yellow-600 px-8 py-4 font-bold rounded">📅 AGENDAR</a>
        </div>
